...
public:
LivingThing(){
  std::cout << "This is the constructor of Living Thing class." << std::endl; 
}
...
class Tree : public Plant {
  public:
  Tree() {
    std::cout << "This is the constructor of Tree class." <<
    std::endl;
  }
...
class Chestnut : public Tree {
  public:
  Chestnut() {
    std::cout << "This is the constructor of Chestnut class." <<
    std::endl;
  }
...
class Cherry : public Tree {
  public:
  Cherry() {
    std::cout << "This is the constructor of Cherry class." <<
    std::endl;
  }
